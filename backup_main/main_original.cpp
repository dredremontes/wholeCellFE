...
void driverVelocities_Explicit(std::vector<Vec3d> &X_t, std::vector<Vec3d> &V_t, std::vector<Vec3d> &V_t_hfl, std::vector<Vec3d> &A_t,double dt);
void updateForces_Explicit(std::vector<Vec3d> &X_t, std::vector<Vec3d> &x_t, std::vector<Vec3d> &V_t, std::vector<Vec3d> &V_t_hlf, std::vector<Vec3d> &A_t, std::vector<VectorXd> &ea_t, double dt, double dt_real, const NonDestructiveTriMesh &mesh);
...
namespace {    
    ...
    void init_simulation( char *script_filename )
    {
        ...
        // NOTE: changing also for concentrations
        g_surf = new SurfTrack( script_init.vertices, script_init.triangles, script_init.masses,script_init.c_B,script_init.c_C,script_init.c_BC, script_init.surf_track_params );   
