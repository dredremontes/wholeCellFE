...
public:
    ...
    std::vector<double>& get_cA( );
    std::vector<double>& get_cB( );
    std::vector<double>& get_cC( );
    std::vector<Vec3d>& get_V_t( );
    ...
    // Velocities, strains
    std::vector<Vec3d> m_Vt;
    std::vector<Vec3d> m_At;
    std::vector<Eigen::VectorXd> m_eat;
...
inline std::vector<double>& DynamicSurface::get_cA( ) 
{
    return m_cA;
}
...
inline std::vector<Vec3d>& DynamicSurface::get_V_t( ) 
{
    return m_Vt;
}

inline std::vector<Vec3d>& DynamicSurface::get_A_t( )
{
    return m_At;
}

inline std::vector<Eigen::VectorXd>& DynamicSurface::get_ea_t( )
{
    return m_eat;
}
